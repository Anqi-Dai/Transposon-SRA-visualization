...
ret <- lapply(list_dfs, function(df){
  pmap(df, function(TE_name, Num){
    ret <- draw_per_bin_boxpot(TE_name, Num)
    
    ggsave(str_glue('../figs/{TE_name}_boxplot.pdf'), arrangeGrob(ret[TE_name][[1]],ret[[2]],ret[[3]], nrow = 3) ,  width = 20, height = 36, dpi = 300) 
})
})
